<template>
  <div>
    ...
    <div
      id="mobile-nav"
      class="absolute w-full h-full transform -translate-x-full z-40 lg:hidden"
    >
      <div
        class="bg-gray-800 opacity-50 w-full h-full absolute"
                ...
                >
                  <div class="flex items-center">
                    <span
                      ...
                      class="xl:text-base md:text-2xl text-base ml-2"
                      >Dashboard</span
                    >
                  </div>
                  <div
