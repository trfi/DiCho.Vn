<template>
  <!--Modal-->
  <div
    class="modal absolute top-0 opacity-0 pointer-events-none w-full h-screen py-4 flex items-center justify-center"
  >
    <div
    ...
    <div
      class="modal-container bg-white w-full h-full max-w-3xl mx-auto rounded shadow-lg z-50"
    >
      <div
