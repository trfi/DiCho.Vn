        ...
        <li>
          ...
          >
            ...
            <div class="w-full pb-2">
              <div class="flex justify-between">
                <span class="block ml-2 font-semibold text-base text-gray-600">Tâm</span>
                <span class="block ml-2 text-sm text-gray-600">5 minutes</span>
              </div>
              <span class="block ml-2 text-sm text-gray-600">Đang làm gì đó?</span>
            </div>
          </a>
          <a
            class="
          ...
          >
            ...
            <div class="w-full pb-2">
              ...
              <span class="block ml-2 text-sm text-gray-600">Tôi ổn. Cảm ơn bạn</span>
            </div>
          </a>
          <a
            class="
          ...
          >
            ...
            <div class="w-full pb-2">
              ...
              <span class="block ml-2 text-sm text-gray-600">Tạm biệt</span>
            </div>
          </a>
        </li>
      </ul>
      ...
      <div class="w-full h-full flex flex-col">
        <div class="flex items-center border-b border-gray-300 pl-3 py-3">
          <img
            ...
            alt="username"
          />
          <span class="block ml-2 font-bold text-base text-gray-600">Trường</span>
        ...
        <div
          id="chat"
          ref="toolbarChat"
          class="w-full overflow-y-auto p-10 h-full relative"
        >
          <ul>
            <li class="clearfix2">
              <div class="w-full flex justify-start">
                ...
                >
                  <span class="block">Chào bro</span>
              ...
              <div class="w-full flex justify-start">
                <div
                  ...
                  style="max-width: 300px"
                >
                  <span class="block">Tôi ổn. Cảm ơn bạn</span>
