<template>
  <div class="py-8 px-8 md:w-3/4 w-full lg:mr-28">
    ...
    <div v-if="post" class="w-full flex flex-row flex-nowrap pt-4">
      <div class="w-2/3">
        <cld-image
          ...
          fetch-format="auto"
          quality="auto"
          class="object-cover max-w-3xl w-full rounded-md"
        />
        <div class="">
