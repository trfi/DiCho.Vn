    ...
    <div class="main_content">
      <div class="container m-auto pt-5">
        ...
        >
          <!-- left message-->
          <div
            class="lg:w-4/12 bg-white border-r overflow-hidden dark:bg-gray-800 dark:border-gray-600"
          >
            <!-- search-->
            <div class="border-b px-4 py-4 dark:border-gray-600">
              <div
                class="bg-gray-100 input-with-icon rounded-md dark:bg-gray-700"
              >
                <input
                ...
                <li>
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0 relative text-gray-500">
                      ...
                      >
                      <p class="truncate">
                        Nam liber tempor <i class="uil-grin-tongue-wink"></i>
                      </p>
                    </div>
                  </a>
                </li>
          ...
          <div class="lg:w-8/12 bg-white dark:bg-gray-800">
            <div class="px-5 py-4 flex uk-flex-between">
              <a href="#" class="flex items-center space-x-3">
                ...
                <div class="flex-1 min-w-0 relative text-gray-500">
                  ...
                  <p class="font-semibold leading-3 text-green-500 text-sm">
                    is online
                  </p>
                </div>
              </a>
              ...
              >
                ...
                <span class="lg:block hidden"> Delete Conversation </span>
              </a>
            </div>
            ...
            <div class="border-t dark:border-gray-600">
              <div class="lg:p-8 p-4 space-y-5">
                <h3
                  class="lg:w-60 mx-auto text-sm uk-heading-line uk-text-center lg:pt-2"
                >
